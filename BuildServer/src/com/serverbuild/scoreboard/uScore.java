...
public class uScore
{
  ...
  public void setScoreboard()
  {
    ...
    for (@SuppressWarnings("rawtypes") Map.Entry Mensagem : this.Scores.entrySet())
    {
      Entry<Team, String> Time = createTeam((String)Mensagem.getKey());
      Integer Score = 
        Integer.valueOf(Mensagem.getValue() != null ? ((Integer)Mensagem.getValue()).intValue() : index);
